/*
	grenade_stop.sqf v0.8 for ArmA 3 Alpha by Bake
...
#define SAFETY_ZONES	[["rainbowspawn", 50]] // Syntax: [["marker1", radius1], ["marker2", radius2], ...]
#define MESSAGE			"Negligent discharge of hand grenade!"
